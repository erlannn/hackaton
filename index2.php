      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <a href="#top" class="logo">
            <img src="images/beritanobg.png" alt="" width="10%" height="10%">
          </a>
          <!-- ***** Logo End ***** -->
          <!-- ***** Menu Start ***** -->
          <ul class="nav">
            <li class="scroll-to-section"><a href="#top" class="active">Home</a></li>
            <li class="scroll-to-section"><a href="modul/kategori/kategori.php">Kategori</a></li>
            <li class="scroll-to-section"><a href="modul/artikel/artikel.php">Artikel</a></li>
            <li class="scroll-to-section"><a href="modul/postkategori/postkategori.php">Postingan Kategori</a></li>
